    ...
    <div className="col-span-1 flex items-center">
      <div className="flex flex-col space-y-4 md:flex-row md:justify-between md:items-center md:space-y-0 w-full">
        ...
        >
          ...
          >
            <span
              onClick={e => filterOrder("All", dispatch, dropdown, setDropdown)}
            ...
            <span
              onClick={e =>
                filterOrder("Processing", dispatch, dropdown, setDropdown)
              }
              className="px-4 py-2 hover:bg-black text-center cursor-pointer"
            >
              Processing
            ...
            <span
              onClick={e =>
                filterOrder("Shipped", dispatch, dropdown, setDropdown)
              }
              className="px-4 py-2 hover:bg-black text-center cursor-pointer"
            >
              Shipped
            ...
            <span
              onClick={e =>
                filterOrder("Delivered", dispatch, dropdown, setDropdown)
              }
              className="px-4 py-2 hover:bg-black text-center cursor-pointer"
            >
              Delivered
            ...
            <span
              onClick={e =>
                filterOrder("Cancelled", dispatch, dropdown, setDropdown)
              }
              className="px-4 py-2 hover:bg-black text-center cursor-pointer"
            >
              Cancelled
