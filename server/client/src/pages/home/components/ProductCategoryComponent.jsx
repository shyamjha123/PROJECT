...
import ProductCategoryDropdownComponent from "./ProductCategoryDropdownComponent";
  ...
  return (
    <>
      <div className="flex justify-between font-medium mt-5">
        <div
          onClick={e =>
            dispatch(categoryListDropdown(!data.categoryListDropdown))
          }
        ...
        <div className="flex space-x-2">
          ...
          <span>/</span>
          <div
            onClick={e => dispatch(searchDropdown(!data.searchDropdown))}
            className={`flex items-center space-x-1 cursor-pointer ${
